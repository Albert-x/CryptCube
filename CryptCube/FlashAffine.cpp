...
IMPLEMENT_DYNAMIC(FlashAffine, CDialog)

FlashAffine::FlashAffine(CWnd* pParent /*=NULL*/)
	: CDialog(FlashAffine::IDD, pParent)
{

}

FlashAffine::~FlashAffine()
{
}

void FlashAffine::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashAffine, CDialog)
END_MESSAGE_MAP()


// FlashAffine 消息处理程序
BOOL FlashAffine::OnInitDialog()
{
...
//	CClientDC dc(this);
	...
	strFileName += "flashSource\\单表置换.swf"; //以上为获的绝对路径
