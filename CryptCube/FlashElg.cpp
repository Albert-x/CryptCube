...
IMPLEMENT_DYNAMIC(CFlashElg, CDialog)

CFlashElg::CFlashElg(CWnd* pParent /*=NULL*/)
	: CDialog(CFlashElg::IDD, pParent)
{
...
void CFlashElg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CFlashElg, CDialog)
END_MESSAGE_MAP()


// CFlashElg 消息处理程序
BOOL CFlashElg::OnInitDialog()
{
	...
	strFileName += "flashSource\\ElGmal.swf"; //以上为获的绝对路径
