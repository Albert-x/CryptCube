...
IMPLEMENT_DYNAMIC(FlashSha, CDialog)

FlashSha::FlashSha(CWnd* pParent /*=NULL*/)
	: CDialog(FlashSha::IDD, pParent)
{
...
void FlashSha::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashSha, CDialog)
END_MESSAGE_MAP()


// FlashSha 消息处理程序
BOOL FlashSha::OnInitDialog()
{
...
//	int vertres = dc.GetDeviceCaps(VERTRES);//宽度
	...
	strFileName += "flashSource\\SHA.swf"; //以上为获的绝对路径
