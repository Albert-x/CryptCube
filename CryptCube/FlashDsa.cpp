...
IMPLEMENT_DYNAMIC(FlashDsa, CDialog)

FlashDsa::FlashDsa(CWnd* pParent /*=NULL*/)
	: CDialog(FlashDsa::IDD, pParent)
{
...
void FlashDsa::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashDsa, CDialog)
END_MESSAGE_MAP()


// FlashDsa 消息处理程序
BOOL FlashDsa::OnInitDialog()
{
...
//	/CClientDC dc(this);
	...
	strFileName += "flashSource\\DSA.swf"; //以上为获的绝对路径
