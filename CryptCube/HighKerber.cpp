...
#include "stdafx.h"
#include "CryptCube.h"
#include "HighKerber.h"



// CHighKerber 对话框

IMPLEMENT_DYNAMIC(CHighKerber, CDialog)

CHighKerber::CHighKerber(CWnd* pParent /*=NULL*/)
	: CDialog(CHighKerber::IDD, pParent)
{

}

CHighKerber::~CHighKerber()
{
}

void CHighKerber::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CHighKerber, CDialog)
END_MESSAGE_MAP()


// CHighKerber 消息处理程序

BOOL CHighKerber::OnInitDialog()
{
