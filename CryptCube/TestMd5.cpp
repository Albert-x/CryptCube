...
IMPLEMENT_DYNAMIC(TestMd5, CDialog)

TestMd5::TestMd5(CWnd* pParent /*=NULL*/)
	: CDialog(TestMd5::IDD, pParent)
{
...
void TestMd5::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(TestMd5, CDialog)
END_MESSAGE_MAP()


// TestMd5 消息处理程序
BOOL TestMd5::OnInitDialog()
{
	...
	strFileName += "flashSource\\MD5-SHAExercise.swf"; //以上为获的绝对路径
