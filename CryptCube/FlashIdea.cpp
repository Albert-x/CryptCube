...
IMPLEMENT_DYNAMIC(CFlashIdea, CDialog)

CFlashIdea::CFlashIdea(CWnd* pParent /*=NULL*/)
	: CDialog(CFlashIdea::IDD, pParent)
{

}

CFlashIdea::~CFlashIdea()
{
}

void CFlashIdea::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CFlashIdea, CDialog)
END_MESSAGE_MAP()


// CFlashIdea 消息处理程序
BOOL CFlashIdea::OnInitDialog()
{
	...
	strFileName += "flashSource\\IDEA.swf"; //以上为获的绝对路径
