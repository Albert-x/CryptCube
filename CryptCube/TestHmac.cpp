...
IMPLEMENT_DYNAMIC(TestHmac, CDialog)

TestHmac::TestHmac(CWnd* pParent /*=NULL*/)
	: CDialog(TestHmac::IDD, pParent)
{
...
void TestHmac::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(TestHmac, CDialog)
END_MESSAGE_MAP()


// TestHmac 消息处理程序
BOOL TestHmac::OnInitDialog()
{
	...
	strFileName += "flashSource\\HMAC_Exercise.swf"; //以上为获的绝对路径
