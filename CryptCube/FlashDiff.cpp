...
IMPLEMENT_DYNAMIC(FlashDiff, CDialog)

FlashDiff::FlashDiff(CWnd* pParent /*=NULL*/)
	: CDialog(FlashDiff::IDD, pParent)
{
...
void FlashDiff::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashDiff, CDialog)
END_MESSAGE_MAP()


// FlashDiff 消息处理程序
BOOL FlashDiff::OnInitDialog()
{
	...
	strFileName += "flashSource\\dh.swf"; //以上为获的绝对路径
