...
IMPLEMENT_DYNAMIC(TestDsa, CDialog)

TestDsa::TestDsa(CWnd* pParent /*=NULL*/)
	: CDialog(TestDsa::IDD, pParent)
{
...
void TestDsa::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(TestDsa, CDialog)
END_MESSAGE_MAP()


// TestDsa 消息处理程序
BOOL TestDsa::OnInitDialog()
{
	...
	strFileName += "flashSource\\RSA-DSAExercise.swf"; //以上为获的绝对路径
