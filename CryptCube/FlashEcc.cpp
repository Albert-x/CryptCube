...
IMPLEMENT_DYNAMIC(CFlashEcc, CDialog)

CFlashEcc::CFlashEcc(CWnd* pParent /*=NULL*/)
	: CDialog(CFlashEcc::IDD, pParent)
{
...
void CFlashEcc::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CFlashEcc, CDialog)
END_MESSAGE_MAP()


// CFlashEcc 消息处理程序
BOOL CFlashEcc::OnInitDialog()
{
	...
	strFileName += "flashSource\\ECC.swf"; //以上为获的绝对路径
