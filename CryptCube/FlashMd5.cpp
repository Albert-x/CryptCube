...
IMPLEMENT_DYNAMIC(FlashMd5, CDialog)

FlashMd5::FlashMd5(CWnd* pParent /*=NULL*/)
	: CDialog(FlashMd5::IDD, pParent)
{
...
void FlashMd5::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashMd5, CDialog)
END_MESSAGE_MAP()


// FlashMd5 消息处理程序
BOOL FlashMd5::OnInitDialog()
{
	...
	strFileName += "flashSource\\MD5.swf"; //以上为获的绝对路径
