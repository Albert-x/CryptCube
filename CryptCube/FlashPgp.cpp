...
IMPLEMENT_DYNAMIC(CFlashPgp, CDialog)

CFlashPgp::CFlashPgp(CWnd* pParent /*=NULL*/)
	: CDialog(CFlashPgp::IDD, pParent)
{
...
void CFlashPgp::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CFlashPgp, CDialog)
END_MESSAGE_MAP()


// CFlashPgp 消息处理程序
BOOL CFlashPgp::OnInitDialog()
{
...
//	m_flashShow.SetWindowPos(&CWnd::wndTop, 0, 0, horzres, vertres, SWP_SHOWWINDOW);
	...
	strFileName += "flashSource\\PGP.swf"; //以上为获的绝对路径
