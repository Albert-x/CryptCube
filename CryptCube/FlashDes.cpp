...
IMPLEMENT_DYNAMIC(FlashDes, CDialog)

FlashDes::FlashDes(CWnd* pParent /*=NULL*/)
	: CDialog(FlashDes::IDD, pParent)
{
...
void FlashDes::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlashDes, CDialog)
	ON_BN_CLICKED(IDCANCEL, &FlashDes::OnBnClickedCancel)
END_MESSAGE_MAP()

BOOL FlashDes::OnInitDialog()
{
...
//	CClientDC dc(this);
	...
	strFileName += "flashSource\\des.swf"; //以上为获的绝对路径
...
void FlashDes::OnBnClickedCancel()
{
	// TODO: 在此添加控件通知处理程序代码
	OnCancel();
}
