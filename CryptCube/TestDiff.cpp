...
IMPLEMENT_DYNAMIC(TestDiff, CDialog)

TestDiff::TestDiff(CWnd* pParent /*=NULL*/)
	: CDialog(TestDiff::IDD, pParent)
{
...
void TestDiff::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(TestDiff, CDialog)
END_MESSAGE_MAP()


// TestDiff 消息处理程序
BOOL TestDiff::OnInitDialog()
{
	...
	strFileName += "flashSource\\D-HExercise.swf"; //以上为获的绝对路径
