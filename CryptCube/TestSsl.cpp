...
IMPLEMENT_DYNAMIC(TestSsl, CDialog)

TestSsl::TestSsl(CWnd* pParent /*=NULL*/)
	: CDialog(TestSsl::IDD, pParent)
{
...
void TestSsl::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(TestSsl, CDialog)
END_MESSAGE_MAP()


// TestSsl 消息处理程序
BOOL TestSsl::OnInitDialog()
{
	...
	strFileName += "flashSource\\SSLExercise.swf"; //以上为获的绝对路径
