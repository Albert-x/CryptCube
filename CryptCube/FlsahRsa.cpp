...
IMPLEMENT_DYNAMIC(FlsahRsa, CDialog)

FlsahRsa::FlsahRsa(CWnd* pParent /*=NULL*/)
	: CDialog(FlsahRsa::IDD, pParent)
{
...
void FlsahRsa::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(FlsahRsa, CDialog)
END_MESSAGE_MAP()


// FlsahRsa 消息处理程序
BOOL FlsahRsa::OnInitDialog()
{
...
//	ShowWindow(SW_SHOWMAXIMIZED ); 
	...
	strFileName += "flashSource\\RSA.swf"; //以上为获的绝对路径
